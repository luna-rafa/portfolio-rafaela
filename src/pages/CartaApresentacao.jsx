    ...
    <main className="relative min-h-screen overflow-x-hidden bg-transparent text-white">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-slate-950/50 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <Link to="/" className="text-lg font-black text-cyan-300">
            Rafaela Rodrigues
          </Link>
          ...
          {[
            {
              ...
              texto: "Experiência com suporte técnico, infraestrutura, Service Desk, Microsoft Azure, Windows Server e Active Directory.",
            },
            {
              titulo: "Visão Analítica",
              texto: "Atuação orientada à resolução estratégica de incidentes, organização operacional e estabilidade de ambientes.",
            },
            {
              titulo: "Evolução Contínua",
              texto: "Aperfeiçoamento em Inteligência Artificial, automação, produtividade e transformação digital.",
            },
          ].map((item) => (
            <div
              key={item.titulo}
