...
export default function Home() {
  const areas = [
    {
      ...
      texto: "Administração de ambientes Windows Server, Active Directory, redes, VPNs e Microsoft Azure.",
    },
    {
      titulo: "Suporte Técnico",
      texto: "Atuação com Service Desk, Help Desk, resolução de incidentes e suporte a usuários corporativos.",
    },
    {
      titulo: "Desenvolvimento & Automação",
      texto: "Vivência com Linux, Docker, Git/GitHub, Python, Node.js, PHP e MySQL.",
    },
  ];
       ...
       <div className="grid items-center gap-10 rounded-[2rem] border border-white/10 bg-white/10 p-6 shadow-2xl shadow-slate-950/40 backdrop-blur-xl md:grid-cols-[1.05fr_0.95fr] md:p-8 lg:p-10">
          <div>
            ...
            <p className="mt-10 max-w-2xl text-base leading-7 text-slate-300 md:text-lg">
              Profissional de Tecnologia com experiência em suporte técnico, infraestrutura e operações corporativas, atuando com Microsoft Azure, Windows Server, Active Directory e ambientes modernos de Service Desk.
               <br />
                <br />
  ...
  >
    LinkedIn
          ...
          <div className="flex items-start justify-center md:-mt-10">
            <div className="relative">
              ...
              <img
                ...
                className="relative h-[380px] w-[380px] rounded-full border border-cyan-300/80 object-cover object-top brightness-95 contrast-105 shadow-[0_0_80px_rgba(34,211,238,0.25)] transition duration-500 hover:scale-[1.02] md:h-[420px] md:w-[420px]"
              />
            </div>
          </div>
        </div>
      ...
      <section id="tecnologias" className="mx-auto max-w-6xl px-6 py-12">
        <p className="text-sm uppercase tracking-[0.35em] text-cyan-300">
          Tecnologias
        </p>
...
<section id="projetos" className="mx-auto max-w-6xl px-6 py-12">
  ...
  <div className="mt-10 grid gap-6 md:grid-cols-3">
    ...
    {[
      {
        titulo: "Portfólio Profissional Tech",

        descricao:
          "Desenvolvimento de portfólio moderno utilizando React, TailwindCSS e Vercel, com foco em performance, responsividade e identidade visual premium.",
...

      {
        ...
        descricao:
          "Criação de site institucional moderno voltado para experiência do usuário, presença digital e identidade visual profissional.",

        stack: ["React", "UI/UX", "Deploy"],

        github: "https://github.com/luna-rafa/site-psicanalista",

        projeto: "https://jaklealpsicanalista.vercel.app/",
      },

      {
        titulo: "Infraestrutura & Operações",

        descricao:
          "Experiência prática com suporte técnico, Active Directory, Microsoft Azure, ambientes Windows corporativos e resolução estratégica de incidentes.",

        stack: ["Azure", "Windows Server", "Service Desk"],
      ...
      >
        ...
        <div className="mt-8 flex gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-xl border border-cyan-400/30 px-4 py-2 text-sm font-medium text-cyan-300 transition hover:bg-cyan-400 hover:text-slate-950"
          >
            GitHub
          </a>
      ...
      <section id="contato" className="mx-auto max-w-6xl px-6 py-16">
        <div className="rounded-[2rem] border border-cyan-400/20 bg-cyan-400/10 p-8 text-center shadow-2xl shadow-slate-950/40 backdrop-blur-xl md:p-12">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-200">
            Disponível para oportunidades em suporte técnico, infraestrutura,
